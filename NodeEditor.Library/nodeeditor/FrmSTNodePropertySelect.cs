...
namespace ST.Library.UI.NodeEditor
{
    internal class FrmSTNodePropertySelect : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            int nIndex = 0;
            object currentValue = m_descriptor.GetValue(null);
            foreach (var v in m_lst_item) {
                string displayText = m_descriptor.GetSelectItemText(v);
                ...
                g.DrawString(displayText, m_descriptor.Control.Font, m_brush, rect_font, m_sf);
